...
- (id)init {
   if (self = [super initWithNibName:@"ProjectViewController" bundle:nil]) {
      self.title = @"Project View Controller";

      UIImage* anImage = [UIImage imageNamed:@"icon-details.png"];
      UITabBarItem* theItem = [[UITabBarItem alloc] initWithTitle:@"Project" image:anImage tag:0];
